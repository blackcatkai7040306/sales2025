import type { AcademyType } from '@/types/academyTypes'
      ...
      content: [
        {
          ...
          id: 'section1',
          topics: [
            { title: 'Lesson1', time: '2.4 min', isCompleted: true },
            { title: 'Lesson2', time: '4.8 min', isCompleted: true },
            { title: 'Lesson3', time: '5.9 min', isCompleted: false },
            { title: 'Lesson4', time: '3.6 min', isCompleted: false },
            { title: 'Lesson5', time: '10.6 min', isCompleted: false }
          ] 
        },
        {
